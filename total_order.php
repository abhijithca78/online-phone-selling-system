                    ...
                    <div class="box">
                        ...
                        <div class="box-body overflow-scroll">
                            <table>
                                ...
                                $records = mysqli_query($conn,"SELECT my_orders.*, products.* FROM my_orders, products WHERE my_orders.phone_id = products.phoneid"); // fetch data from database
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>₹ <?php echo $data['phone_price'] ?></td>
