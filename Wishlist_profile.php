        ...
        <div class="col-lg-8">
            ...
            <div class="table-responsive wishlist-table margin-bottom-none">
                <table class="table">
                    ...
                    <?php
                    $records = mysqli_query($conn,"SELECT wish_list.*, products.* FROM wish_list, products WHERE wish_list.phone_id = products.phoneid and wish_list.uid='$uid';"); // fetch data from database
