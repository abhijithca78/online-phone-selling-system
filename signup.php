   ...
   <body>
      <div class="container">
         ...
         <div class="form-outer">
            <form action="http://localhost/omss/php/insertsignup.php" method="POST" enctype="multipart/form-data">
               ...
               <div class="page">
                  ...
                  <div class="field">
                     ...
                     <input type="radio" name="sex" id="m" value="m">male
                     <input type="radio" name="sex" id="f" value="f">female
                     <input type="radio" name="sex" id="o" value="o">others
                  </div>
                  <div class="field btns">
