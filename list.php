                            ...
                            <table>
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="edit_phone_code.php?id=<?php echo $data['phoneid'];?>&aid=<?php echo $aid ?>" class="nav-link icon"><button class="btn btn-outline">EDIT</button></a></td>
                                        <td> <a href="delete_phones.php?id=<?php echo $data['phoneid']; ?>&aid=<?php echo $aid ?>" class="nav-link icon"><button class="btn btn-outline" >DELETE</button></a></td>
                                    </tr>
                                    <?php
                                    }
                                    ?>
