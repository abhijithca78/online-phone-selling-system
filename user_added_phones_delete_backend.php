...
$del = mysqli_query($conn,"DELETE FROM `user_selled_phones` WHERE phone_id = '$id'"); // delete query

if($del)
{
    mysqli_close($conn); // Close connection
    echo '<script language="javascript">';
    echo 'alert("Successfully Deleted"); location.href="http://localhost/omss/user_added_phones.php?aid='.$aid.'"';
