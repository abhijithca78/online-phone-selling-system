                            ...
                            <table>
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="edit_phone_code1.php?id=<?php echo $data['id']; ?>" class="nav-link icon"><button class="btn btn-outline">EDIT</button></a></td>>
                                    </tr>
                                    <?php
                                    }
                                    ?>
