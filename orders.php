    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <nav class="list-group">
                ...
                <a class="list-group-item with-badge" href="Wishlist_profile.php?uid=<?php echo $uid ?>"><i class="fa fa-heart"></i>Wishlist<span class="badge badge-primary badge-pill">
                <?php
        ...
        <div class="col-lg-8">
            ...
            <div class="table-responsive wishlist-table margin-bottom-none">
                <table class="table">
                    ...
                    $records = mysqli_query($conn,"SELECT my_orders.*, products.* FROM my_orders, products WHERE my_orders.phone_id = products.phoneid and my_orders.userid='$uid'"); // fetch data from database
                    

                    while($data = mysqli_fetch_array($records))
                    {
                        $price=$data['qty'] * $data['phone_price'];
                    ?>
                        <tr>
                            <td>
                                <div class="product-item">
                                    <a class="product-thumb" href="http://localhost/omss/product-details.php?phoneid=<?php echo $data['phoneid']?>&uid=<?php echo $uid ?>"><img src="phone_image/<?php echo $data['phone_image']; ?>" alt="Product"></a>
                                    <div class="product-info">
                                        <h4 class="product-title"><a href="http://localhost/omss/product-details.php?phoneid=<?php echo $data['phoneid']?>&uid=<?php echo $uid ?>"><?php echo $data['phone_name']; ?></a></h4>
                                        <div class="text-lg text-medium text-muted">₹<?php echo $data['phone_price'] ?></div>
                                        <div>Quantity:
