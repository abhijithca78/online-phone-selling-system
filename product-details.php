...
<body>
  ...
  <section class="section product-detail">
    <div class="details container-md">
      ...
      <?php
          ...
          $id=$_GET['phoneid'];
          $records = mysqli_query($conn,"select * from products where phoneid ='$id'") or die( mysqli_error($conn)); // fetch data from database
      ...
      <div class="right">
        ...
        <h1><?php echo $data['phone_name']; ?></h1>
        <div class="price"><?php echo $data['phone_price']; ?></div>
        <form>
          <div>
            <span><i class="bx bx-chevron-down"></i></span>
          </div>
          <a href="cartbackend.php?phoneid=<?php echo $data['phoneid']; ?>&phone_price=<?php echo $data['phone_price']; ?>&uid=<?php echo $uid ?>" class="addCart">Add To Cart</a>
        </form>
  ...
  <section class="section featured">
    ...
    <?php
                ...
                $records = mysqli_query($conn,"select * from products where company_name = '$company'"); // fetch data from database
                if($records)
                {
                while($data = mysqli_fetch_array($records))
                {
            ...
            <div class="product">
                <div class="product-header">
                    ...
                    <ul class="icons">
                        ...
                        <a href="cart.php?phoneid=<?php echo $data['phoneid']; ?>"> <span><i class="bx bx-shopping-bag"></i></span>
                        </a>
                ...
                <div class="product-footer">
                    <a href="product-details.php?phoneid=<?php echo $data['phoneid']; ?>">
