  ...
  <div class="col-12 col-lg-auto mb-3" style="width: 200px;">
    <div class="card p-3">
      <div class="e-navlist e-navlist--active-bg">
        <ul class="nav">
          <li class="nav-item"><a class="nav-link px-2 active" href="http://localhost/omss/product.php?uid=<?php echo $uid ?>"><i class="fa fa-fw fa-bar-chart mr-1"></i><span>Home</span></a></li>
          <li class="nav-item"><a class="nav-link px-2" href="http://localhost/omss/cart.php?uid=<?php echo $uid ?>"><i class="fa fa-fw fa-th mr-1"></i><span>Cart</span></a></li>
        </ul>
      </div>
    </div>
  </div>
